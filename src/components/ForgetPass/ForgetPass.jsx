...
function ForgetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMsg('If your email exists in our system, you will receive a password reset link. Please check your inbox.');
    } catch (err) {
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              <h2 className={`text-2xl font-bold text-center mb-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Forgot Password</h2>
              <p className={`text-center mb-6 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Enter your email to reset your password</p>
