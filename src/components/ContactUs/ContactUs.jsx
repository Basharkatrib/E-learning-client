...
const ContactUs = () => {
  ...
  return (
    <div className={`w-full mt-10 pt-16 pb-14 px-4 sm:px-6 lg:px-8 flex flex-col justify-around items-center ${isDark ? 'bg-gray-900 text-white' : 'bg-gray-50 text-black'}`}>
